...
TEST(LIST_FUNCTIONS, gtest_1) {
  std::list<std::string> a;
  ns::list<std::string> b;
  EXPECT_EQ(a.size(), b.size());
}

TEST(LIST_FUNCTIONS, gtest_2) {
  ns::list<std::string> b(0);
  EXPECT_EQ(b.size(), 0);
}

TEST(LIST_FUNCTIONS, gtest_3) {
  std::list<std::string> a{"number_1", "number_2", "number_3"};
  ns::list<std::string> b{"number_1", "number_2", "number_3"};
  int count[3]{0, 1, 2};
  auto a_it = a.begin();
  auto b_it = b.begin();
...
TEST(LIST_FUNCTIONS, gtest_4) {
  ns::list<std::string> a{"number_1", "number_2", "number_3"};
  ns::list<std::string> b = ns::list<std::string>(a);
  int count[3]{0, 1, 2};
  auto a_it = a.begin();
  auto b_it = b.begin();
  for (auto elem : count) EXPECT_EQ(*a_it++, *b_it++);
...
TEST(LIST_FUNCTIONS, gtest_5) {
  ns::list<std::string> a{"number_1", "number_2", "number_3"};
  ns::list<std::string> b{"number_1", "number_2", "number_3"};
  ns::list<std::string> c(std::move(a));
  int count[3]{0, 1, 2};
  auto c_it = c.begin();
  auto b_it = b.begin();
...
TEST(LIST_FUNCTIONS, gtest_6) {
  ns::list<std::string> a{"number_1", "number_2", "number_3"};
  ns::list<std::string> b{"number_1", "number_2", "number_3"};
  ns::list<std::string> c;
  c = std::move(a);
  int count[3]{0, 1, 2};
  auto c_it = c.begin();
  auto b_it = b.begin();
...
TEST(List_Capacity, test_8) {
  ns::list<std::string> a;
  ns::list<std::string> b{"number_1"};
...
TEST(LIST_MODIFIERS, test_11) {
  ...
  ns::list<std::string> b{"number_1", "number_3"};
  auto a_it = ++a.begin();
  auto b_it = ++b.begin();
...
TEST(LIST_MODIFIERS, test_15) {
  ...
  a.merge(b);
  ns::list<std::string> c{"number_2", "number_3", "number_1"};
  ns::list<std::string> d{"number_5", "number_6", "number_4"};
  c.merge(d);
  auto a_it = a.begin();
...
TEST(LIST_MODIFIERS, test_17) {
  std::list<std::string> a{"number_2", "number_3", "number_1"};
  ns::list<std::string> b{"number_2", "number_3", "number_1"};
  a.reverse();
  b.reverse();
  auto b_it = b.begin();
...
TEST(LIST_PUBLIC, test_22) {
  ns::list<std::string> a{"Hi", "hi", "hi", "hi", "hi", "hi"};
...
TEST(LIST_PUBLIC, test_25) {
  ns::list<char> a{'x', 'e', 'y', 'g', 't', 'a', 's', 'x', 'f'};
