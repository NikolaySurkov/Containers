...
TEST(TEST_MAP, constructor_default_test_1) {
  ns::map<int, NotDefaultConstructor> a;
  EXPECT_EQ(a.size(), 0U);
}

TEST(TEST_MAP, constructor_init_list_test_2) {
  ns::map<int, char> a{
      {1, 'a'},
      {2, 'b'},
      {3, 'c'},
...
TEST(TEST_MAP, constructor_copy_test_3) {
  ns::map<int, char> a{
      {1, 'a'},
      {2, 'b'},
      {3, 'c'},
...
TEST(TEST_MAP, constructor_copy_test_4) {
  ns::map<int, char> const a{
      {1, 'a'},
      {2, 'b'},
      {3, 'c'},
  };
  ns::map<int, char> const b(a);
  EXPECT_EQ(a.size(), b.size());
  EXPECT_EQ(b.size(), 3U);
...
TEST(TEST_MAP, constructor_move_test_5) {
  ns::map<int, char> a{
      {1, 'a'},
      {2, 'b'},
      {3, 'c'},
  };
  ns::map<int, char> const b(std::move(a));
...
TEST(TEST_MAP, operator_eq_copy_test_6) {
  ns::map<int, char> const a{
      {1, 'a'},
      {2, 'b'},
      {3, 'c'},
...
TEST(TEST_MAP, operator_eq_move_test_7) {
  ns::map<int, char> a{
      {1, 'a'},
      {2, 'b'},
      {3, 'c'},
...
TEST(TEST_MAP, operator_eq_move_const_test_8) {
  ns::map<int, char> const a{
      {1, 'a'},
      {2, 'b'},
      {3, 'c'},
...
TEST(TEST_MAP, operator_sq_test_9) {
  ns::map<char, std::string> a{{'a', "Adler"},  {'b', "Berlin"},
                               {'c', "Ctoto"},  {'d', "Dublin"},
                               {'e', "Erevan"}, {'f', "Florecia?"}};
  ns::map<char, std::string> b{{'g', "Grey town"}, {'h', "Hollywood"}};
...
TEST(TEST_MAP, at_insert_not_exception_test_10) {
  ns::map<char, std::string> a{{'a', "Adler"},  {'b', "Berlin"},
                               {'c', "Ctoto"},  {'d', "Dublin"},
                               {'e', "Erevan"}, {'f', "Florecia?"}};
  ns::map<char, std::string> b{{'g', "Grey town"}, {'h', "Hollywood"}};
...
TEST(TEST_MAP, at_insert_exception_test_11) {
  ns::map<char, std::string> a{{'a', "Adler"},  {'b', "Berlin"},
                               {'c', "Ctoto"},  {'d', "Dublin"},
                               {'e', "Erevan"}, {'f', "Florecia?"}};
  ns::map<char, std::string> b{{'g', "Grey town"}, {'h', "Hollywood"}};
...
TEST(TEST_MAP, insert_assign_13) {
  ns::map<char, std::string> a{{'a', "Adler"},  {'b', "Berlin"},
                               {'c', "Ctoto"},  {'d', "Dublin"},
                               {'e', "Erevan"}, {'f', "Florecia?"}};
  ns::map<char, std::string> b{{'g', "Grey town"}, {'h', "Hollywood"}};
...
TEST(TEST_MAP, count_15) {
  ns::map<char, std::size_t> a{{'x', 12U}};
  std::size_t max_size_ns = a.max_size();
  EXPECT_EQ(a['x'], 12U);
  a.insert_or_assign('x', std::move(max_size_ns));
  EXPECT_EQ(a['x'], max_size_ns);
...
TEST(TEST_MAP, insert_many_18) {
  ns::map<char, std::string> a;
...
TEST(TEST_MAP, erase_test_18) {
  ns::map<char, std::string> const a{{'a', "Adler"},  {'b', "Berlin"},
                                     {'c', "Ctoto"},  {'d', "Dublin"},
                                     {'e', "Erevan"}, {'f', "Florecia?"}};
  ;
  EXPECT_TRUE((*a.begin()).first == 'a');
